...
Partial Public Class xrpThongKeSachTraTre
    ...
    Private Sub InitializeComponent()
        ...
        Me.detailTable.LocationFloat = New DevExpress.Utils.PointFloat(10.00036!, 0!)
        ...
        'detailTableCell1
        '
        Me.detailTableCell1.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() {New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TenSach]")})
        ...
        'detailTableCell2
        '
        Me.detailTableCell2.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() {New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NgayMuon]")})
        ...
        'detailTableCell5
        '
        Me.detailTableCell5.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() {New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[SoNgayTraTre]")})
        ...
        Me.XrChart1.LocationFloat = New DevExpress.Utils.PointFloat(127.9788!, 47.91663!)
