...
Public Class ucQuanLySach
    ...
    Private Sub CaiDatGridControl(listDocGia As List(Of SachDTO))
        ...
        grcDanhSachSach.DataSource = listDocGia
    ...
    Private Sub ckeTheLoai_CheckedChanged(sender As Object, e As EventArgs) Handles ckeTheLoai.CheckedChanged

    End Sub

    Private Sub ckeTacGia_CheckedChanged(sender As Object, e As EventArgs) Handles ckeTacGia.CheckedChanged

    End Sub

    Private Sub ckeNamXuatBan_CheckedChanged(sender As Object, e As EventArgs) Handles ckeNamXuatBan.CheckedChanged

    End Sub

    Private Sub ckeTrangThai_CheckedChanged(sender As Object, e As EventArgs) Handles ckeTrangThai.CheckedChanged

    End Sub

    Private Sub lueTheLoai_EditValueChanged(sender As Object, e As EventArgs) Handles lueLocTheLoai.EditValueChanged

    End Sub

    Private Sub lueTacGia_EditValueChanged(sender As Object, e As EventArgs) Handles lueLocTacGia.EditValueChanged

    End Sub

    Private Sub dteLocNamXuatBan_EditValueChanged(sender As Object, e As EventArgs) Handles dteLocNamXuatBan.EditValueChanged

    End Sub

    Private Sub lueLocTrangThai_EditValueChanged(sender As Object, e As EventArgs) Handles lueLocTrangThai.EditValueChanged
